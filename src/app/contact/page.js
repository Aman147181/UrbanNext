  ...
  return (
    <div className="min-h-screen pt-20 pb-5">
      <div className="flex w-full items-center flex-col justify-center">
        <h1 className="text-black font-volkhov font-medium px-2  text-5xl">
          Get in Touch
        </h1>
        <h1 className="text-xl font-roboto font-normal px-5 pt-2 pb-5">
          If you have any questions, comments, or inquiries, feel free to reach
          out to us. Our dedicated team is ready to assist you in any way we
          can.
        </h1>
      </div>
      <div className="grid lg:grid-cols-2 grid-cols-1 w-full mt-20 px-5 sm:px-12 md:px-16 lg:px-20 customsm:gap-10  sm:gap-16">
